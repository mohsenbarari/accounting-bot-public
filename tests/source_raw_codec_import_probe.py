"""Guard fresh codec execution; dependency and code loading precede the guard."""
...
TARGET = "accounting_contracts.source_raw_codec"
PUBLIC_NAMES = (
...
def main() -> int:
    ...
    assert module.SOURCE_RAW_CODEC_VERSION == "source-raw-codec.v1"
