"""Guard exact fiscal-module execution; dependency/bootstrap reads are outside it.
...
TARGET = "accounting_contracts.source_fiscal_evidence"
PUBLIC_NAMES = (
...
def forbidden(*args: Any, **kwargs: Any) -> Any:
    raise ForbiddenSideEffect("Fiscal evidence side-effect guard")
...
def main() -> int:
    ...
    assert module.SOURCE_FISCAL_EVIDENCE_VERSION == "source-fiscal-evidence.v1"
