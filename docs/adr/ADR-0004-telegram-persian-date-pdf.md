...
این تصمیم در O-55 تأیید شده و G0 در 2026-08-30 بسته شده است. جایگزینی فنی یا تغییر قابل‌مشاهده داخل چشم‌انداز مصوب فقط با شاهد، ADR و تصمیم Codex مدیر پروژه ممکن است؛ تغییر جهت صریح مالک یا اقدام Production اختیار هدف‌دار مالک را می‌خواهد.
