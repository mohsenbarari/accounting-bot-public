...
- G0 هنوز تصویب نشده و این ADR مجوز کدنویسی محصول نیست.
...
این تصمیم قبلاً توسط کاربر در O-52 تأیید شده است. اجرای آن فقط پس از تصویب صریح G0 و در Work Package بازبینی‌شده مجاز است.
